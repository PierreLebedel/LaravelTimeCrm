...
new #[Title('Calendrier FullCalendar')] class extends Component
{
    use Toast;
...
<div class="space-y-6">
    <x-header
        title="Calendrier hebdomadaire FullCalendar"
        subtitle="Vue de test avec drag and drop, resize et creation par selection de plage."
        separator
    >
        <x-slot:actions>
            <x-button label="Vue classique" icon="tabler.layout-sidebar-left" link="{{ route('calendar') }}" />
        </x-slot:actions>
    </x-header>
